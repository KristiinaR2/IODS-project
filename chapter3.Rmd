...
alc_agg <- alc %>%
  ...
  summarise(famrel_mean = round(mean(famrel), digits = 2),
...
#Plot of 'high_use' by family relations
ggplot(alc, aes(high_use)) + facet_wrap("famrel") + geom_bar()
...
#Plot of 'high_use' by mothers education 
ggplot(alc, aes(high_use)) + facet_wrap("Medu") + geom_bar()
...
#Plot of 'high_use' by fathers education 
ggplot(alc, aes(high_use)) + facet_wrap("Fedu") + geom_bar()
