...
According to the previous logistic regression model the sex (M) and family relations had a statistical relationship with high/low alcohol consumption. 

The model (m2) shows that the AIC (435.26) is almost the same as it was in the previous model (438.88).
